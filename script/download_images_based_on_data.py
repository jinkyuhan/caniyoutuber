...
# open data file
file_names = ['subscriber_300_upper', 'subscriber_100_upper', 'subscriber_50_upper', 'subscriber_30_upper', 'subscriber_10_upper']
many_csv_data = []
total_data_num = 0
for file_name in file_names:
    ...
    for row_idx in range(len(csv_data)):
        ...
        channel = {
            'keyword': (channel_name + ' 얼굴') if category != '애완%2F반려동물' else (channel_name + ' 근접'),
            'limit': 10,
